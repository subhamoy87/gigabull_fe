    ...
    <div className='w-full font-sans bg-white text-[#2d2d2d]'>
      ...
      <section className='container mx-auto py-10 px-6 text-[18px] leading-relaxed space-y-6'>
        ...
        <p>
          ...
          customer. Spotdeal Enterprises shall not be liable for any delay /
          non-delivery of purchased goods by flood, fire, wars, acts of God or
          any cause that is beyond the control of Spotdeal Enterprises.
        </p>
        <p>
          The client should consent to give valid and genuine data, to stay away
          from any sort of postponement or loss of merchandise. Spotdeal
          Enterprises reserves the right to confirm and validate the information
        ...
        <p className='font-bold text-[#1f1f1f]'>
          ...
          the customer. Spotdeal Enterprises is not liable to pay any Duties or
